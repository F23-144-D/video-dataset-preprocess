...
# Split the label files accordingly
# Get the corresponding label files
train_label_files = [os.path.join('UCF-yolo', os.path.relpath(image_file, 'UCF101_n_frames')).replace('.jpg', '.txt') for image_file in train_image_files]
val_label_files = [os.path.join('UCF-yolo', os.path.relpath(image_file, 'UCF101_n_frames')).replace('.jpg', '.txt') for image_file in val_image_files]
test_label_files = [os.path.join('UCF-yolo', os.path.relpath(image_file, 'UCF101_n_frames')).replace('.jpg', '.txt') for image_file in test_image_files]
