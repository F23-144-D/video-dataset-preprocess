...
class UCFDataset(Dataset):
    ...
    def __init__(self, root_dir, info_list, split='train', clip_len=16, save_dir=None):
        ...
        with open('/workspaces/video-dataset-preprocess/Dataset/ucfTrainTestlist/classInd.txt') as f:
            for line in f:
                line=line.strip('\n').split(' ')
    ...
    def __getitem__(self, index):
        ...
        if self.transform:
            ...
            for i, frame in enumerate(buffer):
                save_path = os.path.join(self.save_dir, f"{index}_{i}.png")
...
if __name__ == '__main__':
    # usage
    root_list = '/workspaces/video-dataset-preprocess/Dataset/UCF101_n_frames/'
    info_list = '/workspaces/video-dataset-preprocess/Dataset/ucfTrainTestlist/updated_videos.txt'
    ...
    save_directory = '/workspaces/video-dataset-preprocess/Dataset/UCF-preprocessed'
